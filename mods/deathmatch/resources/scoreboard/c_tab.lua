...
local SCOREBOARD_INFO_BACKGROUND	= { 0, 0, 0, 100 }			-- RGBA color for the info header background
local SCOREBOARD_SERVER_NAME_COLOR	= { 50, 205, 50, 200 }		-- RGBA color for the server name text
local SCOREBOARD_PLAYERCOUNT_COLOR	= { 255, 255, 255, 160 }	-- RGBA color for the server player count text
local SCOREBOARD_BACKGROUND			= { 0, 0, 0, 135 }			-- RGBA color for the background
local SCOREBOARD_BACKGROUND_IMAGE	= { 255, 255, 255, 255 }		-- RGBA color for the background image
local SCOREBOARD_HEADERS_COLOR		= { 50, 205, 50, 141 }	-- RGBA color for the headers
local SCOREBOARD_SEPARATOR_COLOR	= { 50, 205, 50, 140 }		-- RGBA color for the separator line between headers and body content
local SCOREBOARD_SCROLL_BACKGROUND	= { 0, 10, 20, 100 }		-- RGBA color for the scroll background
local SCOREBOARD_SCROLL_FOREGROUND	= { 15, 177, 253, 200 }		-- RGBA color for the scroll foreground
...
drawBackground = function ()
	...
	if g_currentHeight > SCOREBOARD_HEADER_HEIGHT then
		...
		dxDrawImage ( SCOREBOARD_X + 100, SCOREBOARD_Y + 110,
					  SCOREBOARD_WIDTH - 200, SCOREBOARD_HEIGHT - 150,
					  "icon.png", 0, 250, 3, SCOREBOARD_BACKGROUND_IMAGE, SCOREBOARD_POSTGUI )
		-- Overlay
